...
cd your-project/
mkdir -p .clinerules
curl -L https://raw.githubusercontent.com/xBelowZero/claude-skill-performance-audit/main/adapters/cline/performance-audit.md -o .clinerules/performance-audit.md
```
...
- **No Task tool** — to dispatch a fresh auditor, open a new Cline conversation and paste [auditor-prompt](https://github.com/xBelowZero/claude-skill-performance-audit/blob/main/auditor-prompt.md).
