...
```bash
cd your-project/
curl -L https://raw.githubusercontent.com/xBelowZero/claude-skill-performance-audit/main/adapters/codex/AGENTS.md -o AGENTS.md
```
...
- **No Task tool** — to dispatch a fresh auditor, open a new Codex session and paste [auditor-prompt](https://github.com/xBelowZero/claude-skill-performance-audit/blob/main/auditor-prompt.md).
